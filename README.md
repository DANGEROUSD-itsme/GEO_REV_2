...
js/
  ...
  core/
    ...
    cursor.js  magnetic.js  reveal.js  counters.js  nav.js  boot.js
...
- **Reveals** — headings are split into *measured lines*, each clipped and slid
  up; blocks stagger in via ScrollTrigger; stats count up on entry.
...
- **Keyboard** — everything is operable: skip link, focus-visible rings, the
