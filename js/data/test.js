...
GEO.data.PART_A = [
  ...
  { q:'Indigenous Australians’ connection to the ancient rock art at Murujuga (Burrup Peninsula) is best classified as which connection criterion?',
    ...
    answer:1,
    explain:'A sacred, belief-based connection to Country is a spiritual connection. Economic would be the correct answer for the mining and gas corporations that value the same site as an industrial hub, which is the classic contested-perspectives pairing.' },
...
GEO.data.PART_C = {
  ...
  exemplar:[
    ...
    { heading:'Paragraph 4: Management strategies and evaluation', body:[
      ...
      { tag:'E2', text:'For example, the Louvre has required strict mandatory pre-booked entry since 2026, turning away non-reservations, which is moderately effective since it spreads visitors through the day, though it does not reduce citywide numbers and tickets sell out weeks ahead; Airbnb regulation caps primary-residence letting at 120 days per year (with a proposed 90-day limit in hot-spots), requires centralised digital registration and imposes fines of €15,000 to €100,000, with court-issued fines falling from €3.5 million in 2021 to €535k in the first seven months of 2023, indicating improved compliance although the housing shortage persists; and proposed dispersal would promote the 19th and 20th Arrondissements, Belleville and regional towns such as Fontainebleau through transport links and targeted advertising, following successful models in Amsterdam and Venice.' },
