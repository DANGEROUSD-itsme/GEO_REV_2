...
GEO.data.DECKS = [
  ...
  { id:'paris-strats', name:'Paris Strategies', icon:'shield-check', blurb:'Mechanism / Pros / Cons / Effectiveness for all three strategies.',
    cards:[
      ...
      { q:'<strong>Airbnb regulations</strong>: mechanism?', a:'Primary-residence rentals capped at 120 days/year (proposed drop to 90 days in hot-spots), centralised digital registration required, and fines of €15,000 to €100,000.' },
